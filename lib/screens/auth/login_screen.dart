...
import '../driver/driver_dashboard.dart'; // <--- NEW: Imported the Driver Dashboard!
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  // 🚦 The Upgraded 3-Way Role-Based Traffic Controller
  Future<void> _login() async {
    ...
    try {
      ...
      if (res.user != null && mounted) {
        ...
        // Route them to the correct dashboard based on their exact role
        if (role == 'merchant') {
          ...
          // NEW: Drivers are securely routed to their own dashboard!
          Navigator.pushAndRemoveUntil(
            context,
